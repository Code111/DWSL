...
class Model(nn.Module):
    def __init__(self, configs, pe:str='zeros', learn_pe:bool=True, pretrain_head:bool=False, head_type = 'flatten'):
        ...
        pad_size = configs.pad_size
        local_size = configs.local_size

        self.model = backbone(c_in=c_in, pad_size=pad_size, local_size=local_size, context_window = context_window, target_window=target_window, patch_len=patch_len, stride=stride,
